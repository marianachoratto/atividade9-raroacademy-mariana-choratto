...
*** Test Cases ***
T35- O usuário deve conseguir interagir com a sessão Investimentos
...
T36- O usuário deve conseguir interagir com a sessão Investimentos clicando no botão Conhecer
    Dado que acessei o aplicativo Nubank Clone
